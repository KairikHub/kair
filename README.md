...
- `.contracts/<contract_id>/artifacts/run/run-request.json`
- `.contracts/<contract_id>/artifacts/run/run-result.json`
...
Run prerequisites:
- `.contracts/<contract_id>/plan/plan_v1.json`
- `.contracts/<contract_id>/plan/RULES.md` (may be empty)
- Approval artifact `.contracts/<contract_id>/approvals/<plan_hash>.json` unless `--dry-run`
